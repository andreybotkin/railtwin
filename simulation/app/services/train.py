...
class TrainService:
    ...
    def _payload_to_response(self, train: dict[str, Any]) -> TrainResponse:
        ...
        return TrainResponse(
            ...
            locomotive_mass_t=train.get("locomotive_mass_t"),
            rolling_stock_mass_t=train.get("rolling_stock_mass_t"),
            horsepower=train.get("horsepower"),
            max_tractive_effort_kn=train.get("max_tractive_effort_kn"),
            max_brake_deceleration_mps2=train.get("max_brake_deceleration_mps2"),
            max_speed_kmh=train.get("max_speed_kmh"),
            passenger_load=train.get("passenger_load"),
            passenger_mass_kg=train.get("passenger_mass_kg"),
    ...
    def _train_to_response(self, train: Train) -> TrainResponse:
        ...
        return TrainResponse(
            ...
            locomotive_mass_t=train.locomotive_mass_t,
            rolling_stock_mass_t=train.rolling_stock_mass_t,
            horsepower=train.horsepower,
            max_tractive_effort_kn=train.max_tractive_effort_kn,
            max_brake_deceleration_mps2=train.max_brake_deceleration_mps2,
            max_speed_kmh=train.max_speed_kmh,
            passenger_load=train.passenger_load,
            passenger_mass_kg=train.passenger_mass_kg,
            operator=train.operator,
            source=train.source,
