...
simulation application using Pydantic Settings for environment variable management.
"""
...
class Settings(BaseSettings):
    ...
    reference_data_namespace: str = "sim:ref:v1"
    reference_data_batch_size: int = 500
    reference_data_required: bool = True
    ...
    def get_position_cache_interval_seconds(self) -> int:
        ...
        # Position snapshots are only a coarse cache; the frontend animates from
        # trajectory time_intervals, so 10s snapshots do not reduce perceived quality.
