...
t_trains = sa.Table(
    ...
    sa.Column("locomotive_mass_t", sa.Numeric(8, 2), nullable=True),
    sa.Column("rolling_stock_mass_t", sa.Numeric(9, 2), nullable=True),
    sa.Column("horsepower", sa.Numeric(8, 1), nullable=True),
    sa.Column("max_tractive_effort_kn", sa.Numeric(8, 2), nullable=True),
    sa.Column("max_brake_deceleration_mps2", sa.Numeric(5, 3), nullable=True),
    sa.Column("max_speed_kmh", sa.Numeric(6, 2), nullable=True),
    sa.Column("passenger_load", sa.Integer(), nullable=True),
    sa.Column("passenger_mass_kg", sa.Numeric(6, 2), nullable=True),
...
t_network_edges = sa.Table(
    ...
    sa.Column("speed_limit_zones", sa.JSON(), nullable=True),
