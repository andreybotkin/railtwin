"""SQLAlchemy Core table definitions for raildatacollector.
...
schema – Alembic (in raildbsetup) remains the single source of truth for DDL.
"""
...
t_network_edge_routes = sa.Table(
    "network_edge_routes",
    metadata,
    sa.Column("id", sa.Integer(), primary_key=True),
    sa.Column("edge_id", sa.Integer(), nullable=False),
